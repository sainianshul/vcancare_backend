...
<div class="card shadow-none border border-gray-300 mb-5 mb-xl-8 mt-5 mt-xl-8">
    ...
    <div class="card-body pt-4 pb-8">
        ...
        <div class="d-flex flex-column gap-6">
            ...
            @empty
                <div class="d-flex align-items-center justify-content-center flex-column py-8 border border-gray-300 border-dashed rounded bg-light">
                    <img src="{{ asset('media/not_found.svg') }}" alt="No notes found" style="height: 120px;" class="mb-4 opacity-75" />
                    <span class="text-gray-500 fw-medium fs-6">No notes have been added yet.</span>
                </div>
            @endforelse
        </div>
    </div>
