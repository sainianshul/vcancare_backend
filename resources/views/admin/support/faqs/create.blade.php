...
@section('content')
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <x-page-header title="Add FAQ" description="Create a new frequently asked question" />
                <x-breadcrumb :items="[
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <form method="POST" action="{{ route('admin.support.faqs.store') }}" class="form d-flex flex-column flex-lg-row">
                @csrf
                    ...
                    <div class="card card-flush py-4 card-bordered border-gray-300 shadow-sm">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-7">
                                ...
                                <div class="position-relative">
                                    ...
                                    <input type="text" name="question" class="form-control text-gray-900 border border-gray-300 bg-transparent ps-12 @error('question') is-invalid @enderror"
                                        placeholder="Enter the question..." value="{{ old('question') }}" required />
                                </div>
                            ...
                            <div class="mb-7">
                                ...
                                <textarea name="answer" class="form-control text-gray-900 border border-gray-300 bg-transparent @error('answer') is-invalid @enderror" rows="6" placeholder="Enter the detailed answer..." required>{{ old('answer') }}</textarea>
                    ...
                    <div class="card card-flush py-4 card-bordered border-gray-300 shadow-sm" style="position:sticky;top:90px;">
                        ...
                        <div class="card-body pt-0">
                            <select name="status" class="form-select text-gray-900 border border-gray-300 bg-transparent" data-control="select2" data-hide-search="true" required>
                                @foreach($statuses as $value => $label)
                                    <option value="{{ $value }}" {{ old('status', \App\Models\Faq::STATUS_ACTIVE) == $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="card-footer pt-0 border-0 mt-5">
                            <button type="submit" class="btn btn-light-primary border border-primary fw-bold w-100 shadow-sm">
                                <i class="ki-outline ki-check fs-4 me-1"></i>Save FAQ
                            </button>
                        </div>
                    </div>
                    <!--end::Status-->
