...
@section('content')
    ...
    <div class="card shadow-sm border border-gray-200">
        ...
        <div class="card-header border-bottom border-gray-200 pt-5 pb-4">
            <div class="d-flex align-items-center justify-content-between w-100 flex-wrap gap-3">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="{{ route('admin.support.categories.index') }}" class="btn btn-sm btn-light-primary fw-bold shadow-sm d-flex align-items-center">
                        <i class="ki-outline ki-category fs-4 me-1"></i> Manage Category
                    </a>
                    ...
                    <div style="width: 160px;">
                        <div class="position-relative">
                            <i class="ki-duotone ki-category fs-5 text-gray-900 position-absolute top-50 start-0 translate-middle-y ms-4 z-index-3">
                                <span class="path1"></span>
                                <span class="path2"></span>
        ...
        <div class="card-body py-4">
            ...
            <div id="tickets-table-wrapper" class="table-responsive">
                <table
                    id="tickets-table"
                ...
                >
                    <thead>
                        <tr class="text-start text-gray-500 fw-bold fs-9 text-uppercase gs-0 border-bottom border-gray-200 border-1">
                            ...
                            <th class="min-w-120px">Priority</th>
    ...
    <script>
        $(function () {
            ...
            let table = $('#tickets-table').DataTable({
                ...
                processing: false,
                ajax: {
                    url: '{{ route("admin.support.index") }}', // Current URL
                    data: function (d) {
                ...
                columns: [
                    ...
                    { data: 'subject_category', name: 'subject', orderable: false, searchable: false },
                ...
                initComplete: function () {
                    $('#tickets-skeleton').fadeOut(200, function () {
                        $(this).remove();
                    });
                },
