    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            @if($profile->status == \App\Models\NurseProfile::STATUS_REJECTED)
                <div class="alert alert-dismissible bg-light-danger border border-danger border-dashed d-flex flex-column flex-sm-row w-100 p-5 mb-10 shadow-sm">
                    ...
                    <div class="d-flex flex-column pe-0 pe-sm-10">
                        ...
                        <span class="text-gray-800 fw-medium">Reason: {{ $profile->rejection_reason ?? 'No final reason provided.' }}</span>
                    </div>
                </div>
            @endif
                                ...
                                <div class="d-flex flex-column w-100">
                                    <div class="d-flex justify-content-between align-items-center w-100">
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <span class="badge badge-light-primary border border-primary fw-semibold px-3 py-1">
                    ...
                    <div class="d-flex flex-column gap-2" id="verification-nav">
                        ...
                        @foreach($steps as $stepId => $stepData)
                            ...
                            <div class="step-nav-item cursor-pointer d-flex align-items-center px-4 py-3 rounded transition-all {{ $loop->first ? 'bg-light-primary border border-primary' : 'hover-bg-light border border-transparent' }}" 
                                ...
                                <div class="w-25px h-25px rounded-circle d-flex align-items-center justify-content-center me-4 {{ $circleClass }}">
                                    {!! $iconContent !!}
                                </div>
                                <span class="fw-semibold fs-7 {{ $loop->first ? 'text-primary' : 'text-gray-900' }} nav-label">{{ $stepData['name'] }}</span>
                            </div>
                        @endforeach
                        ...
                        <div class="step-nav-item cursor-pointer d-flex align-items-center px-4 py-3 rounded transition-all hover-bg-light border border-transparent" 
                            ...
                            <div class="w-25px h-25px rounded-circle bg-dark d-flex align-items-center justify-content-center me-4">
