<div class="card shadow-sm border border-gray-300">
    <div class="card-body pt-6 pb-5">
        @include('admin.layouts.partials._table-skeleton', ['id' => 'nurse-bookings-skeleton'])
        
        <div id="nurse-bookings-table-wrapper" class="table-responsive d-none">
            <table id="nurse-bookings-table" class="table align-middle table-row-dashed table-row-gray-200 gs-0 gy-4 w-100" data-server-side="true">
                <thead>
    ...
    if (typeof jQuery !== 'undefined') {
        $('#nurse-bookings-table').DataTable({
            ...
            initComplete: function () {
                $('#nurse-bookings-skeleton').fadeOut(200, function () {
                    $(this).remove();
                    $('#nurse-bookings-table-wrapper').removeClass('d-none').hide().fadeIn(200);
                });
            }
        });
    }
