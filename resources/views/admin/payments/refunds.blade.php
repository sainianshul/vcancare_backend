...
@section('title', 'Refunds & Payment Logs')

@section('content')

    <x-breadcrumb :items="[
        ['label' => 'Refunds & Payment Logs'],
    ]" />
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body py-4">
            ...
            <div id="refunds-table-wrapper" class="table-responsive">
                <table
                    id="refunds-table"
                ...
                >
                    <thead>
                        <tr class="text-start text-gray-900 fw-medium fs-7 text-uppercase gs-0 border-bottom border-gray-200 border-1">
                            ...
                            <th class="min-w-200px">Gateway Info</th>
                            <th class="min-w-150px">Event</th>
                            <th class="min-w-120px">Amount</th>
                            <th class="min-w-150px">Gateway Status</th>
...
@push('datatables_js')
    ...
    <script>
        $(function () {
            let table = $('#refunds-table').DataTable({
                serverSide: true,
                processing: false,
                ajax: {
                    url: '{{ route("admin.payments.refunds-data") }}',
                    data: function (d) {
                ...
                columns: [
                    ...
                    { data: 'gateway_info', name: 'gateway_info', orderable: false, searchable: false },
                ...
                language: {
                    ...
                    zeroRecords: ' ',
                    loadingRecords: ' ',
                    info: 'Showing _START_–_END_ of _TOTAL_ refunds',
                    infoEmpty: 'No refunds to show',
                ...
                initComplete: function () {
                    $('#refunds-skeleton').fadeOut(200, function () {
                        $(this).remove();
                    });
                },
                drawCallback: function () {
                    ...
                    if (total === 0) {
                        $('#refunds-table-wrapper').addClass('d-none');
                        $('#refunds-empty').removeClass('d-none');
                    } else {
                        $('#refunds-empty').addClass('d-none');
                        $('#refunds-table-wrapper').removeClass('d-none');
                    }
